...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let creds = '{"clientId": "0b967e7f-5f4e-4f5c-a9f2-d620862d0229","clientSecret": "RdU7Q~zWZanyF4c61KgB_85pjl5~6CAAU_jJN","subscriptionId": "58928cd6-47cb-46d6-bc64-f1cf885c0158","tenantId": "b69d3527-5bf7-431b-9789-ef76cc04bfc5","resourceManagerEndpointUrl": "https://management.azure.com/"}';
            let secrets = creds ? new actions_secret_parser_1.SecretParser(creds, actions_secret_parser_1.FormatType.JSON) : null;
            let environment = "azurecloud";
			...
			console.log("Login Command = ", loginOptions, commonArgs);
